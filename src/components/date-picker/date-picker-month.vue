<template lang="pug">
  .lcalendar__months 
    button.lcalendar__months-btn(@click="toggleCurrentMonth(-1)")
      i.fas.fa-chevron-left
    ul.lcalendar__months-list
      li.lcalendar__month
        button.lcalendar__month-btn(@click="toggleCurrentMonth(-1)") {{ prevMonth }}
      li.lcalendar__month.lcalendar__month_active
        button.lcalendar__month-btn {{ currentMonth }}
      li.lcalendar__month
        button.lcalendar__month-btn(@click="toggleCurrentMonth(1)") {{ nextMonth }}
    button.lcalendar__months-btn(@click="toggleCurrentMonth(1)")
